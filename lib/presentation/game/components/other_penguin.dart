...
class OtherPenguin extends SpriteAnimationComponent with HasGameRef<ClubPenguinGame> {
  ...
  OtherPenguin({required this.user}) {
    ...
    _chatIdleAnimation = _chatIdleSpriteSheet.createAnimation(stepTime: 0.1, row: 0);
    _walkAnimation = _walkSpriteSheet.createAnimation(stepTime: 0.1, row: 0);
    _chatWalkAnimation = _chatWalkSpriteSheet.createAnimation(stepTime: 0.1, row: 0);
