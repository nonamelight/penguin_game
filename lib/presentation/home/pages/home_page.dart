          ...
          child: Consumer<ChatProvider>(
            builder: (_, chatProvider, __) {
              return TextFormField(
                ...
                decoration: const InputDecoration(border: InputBorder.none, hintText: _hintText, contentPadding: EdgeInsets.all(20), hintStyle: TextStyle(fontSize: 8, color: Colors.black45), fillColor: Colors.white, filled: true),
              );
            },
          ),
        ),
          ...
          child: Consumer<WorldProvider>(
            builder: (context, worldProvider, child) {
              return AnimatedCrossFade(
                ...
                crossFadeState: worldProvider.currentBackground == Background.day ? CrossFadeState.showFirst : CrossFadeState.showSecond,
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        ...
        children: [
          Lottie.asset('assets/error_dino.json', height: 200, width: 200, frameRate: FrameRate.max),
          const Padding(
